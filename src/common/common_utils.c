...
uint64_t gpuio_hash_bytes(const void* data, size_t len, uint64_t seed) {
    ...
    switch (len & 7) {
        case 7: h ^= (uint64_t)(data8[6]) << 48; __attribute__((fallthrough));
        case 6: h ^= (uint64_t)(data8[5]) << 40; __attribute__((fallthrough));
        case 5: h ^= (uint64_t)(data8[4]) << 32; __attribute__((fallthrough));
        case 4: h ^= (uint64_t)(data8[3]) << 24; __attribute__((fallthrough));
        case 3: h ^= (uint64_t)(data8[2]) << 16; __attribute__((fallthrough));
        case 2: h ^= (uint64_t)(data8[1]) << 8; __attribute__((fallthrough));
